...
namespace Hands_On_3
{
    ...
    class PermanantEmployee : Person
    {
        private double HRA;
        private double DA;
        private double Tax;
        ...
        public PermanantEmployee(string f_name, string l_name, string e_id, DateTime dob, double Base_salary) : base(f_name, l_name, e_id, dob)
        {
    ...
    class ProgramTest
    {
        static void Main(string[] args)
        {
            ...
            PermanantEmployee p1 = new PermanantEmployee(f_name, l_name, e_id, dob, base_salary);
            p1.Display();
